...
public class GreenActivity extends Activity {
	...
	private ListView myGreenMembers;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myGreenMembers = (ListView) findViewById(R.id.listView1);
		myGreenMembers.setAdapter(new GetAllWorkerAdapter(GreenActivity.this,
				loadAllColorEmployee));

		myGreenMembers.setOnItemClickListener(new OnItemClickListener() {
			@Override
